    ...
    */
    ...
    public JoystickView(Context context, AttributeSet attrs) {
        ...
        TypedArray styledAttributes = context.getTheme().obtainStyledAttributes(
                attrs, R.styleable.JoystickView,
                0, 0
        );
...
//    private Point center, userPoint;
//    private RectF oval_rectangle;
//    private Paint paint;
//    private int line_a, lina_b, radius;
...
//        oval_rectangle = new RectF(0, 0, getWidth(), getHeight());
//
//
//
//
//        mExampleString = a.getString(
//                R.styleable.Joystick_exampleString);
//        mExampleColor = a.getColor(
//                R.styleable.Joystick_exampleColor,
//                mExampleColor);
//        // Use getDimensionPixelSize or getDimensionPixelOffset when dealing with
//        // values that should fall on pixel boundaries.
//        mExampleDimension = a.getDimension(
//                R.styleable.Joystick_exampleDimension,
//                mExampleDimension);
//
//        if (a.hasValue(R.styleable.Joystick_exampleDrawable)) {
//            mExampleDrawable = a.getDrawable(
//                    R.styleable.Joystick_exampleDrawable);
...
//        super.onDraw(canvas);
//
//        canvas.drawOval(oval_rectangle, paint);
//        canvas.drawCircle(userPoint.x, userPoint.y, radius, paint);
//    }
//
//    @Override
//    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
